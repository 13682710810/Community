...
public class MessageController implements CommunityConstant {
    ...
    //分割会话Id,112_221，分割为112,221.并进行查询
    ...
    public String sendLetter(String toName, String content) {
        ...
        //会话Id,小的在前，大的在后.统一方便，否则容易看成是两个会话
    ...
    public String getNoticeList(Model model){
        ...
        if(message != null){
            ...
            //将带有转义字符的消息转化为正常不带转义字符的消息
            String content = HtmlUtils.htmlUnescape(message.getContent());
            //将字符串转化为对象，EventConsumer里把content转化为JSON是MAP格式，因此要用HashMap.class
    ...
    public String getNoticeDetail(@PathVariable(value = "topic")String topic,Page page,Model model){
        User user = hostHolder.getUser();
        page.setLimit(5);
